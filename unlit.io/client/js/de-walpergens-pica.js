...
window.Typekit.config = {
    "f": "//use.edgefonts.net/c/65a32f/1w;de-walpergens-pica,2,Wk8:W:i4,Wk9:W:n4/{format}{/extras*}",
    "fi": [6152, 6153],
    "fn": ["de-walpergens-pica", ["i4", "n4"]],
    "ht": "tk",
    "js": "1.14.9",
    "p": "//p.typekit.net/p.gif?s=4&h={host}&f=6152.6153&app={app}&_={_}",
    "ps": 4
};;
